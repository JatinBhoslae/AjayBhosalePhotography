...
export default function Lightbox({ items, index, onClose, onChange }) {
  ...
  useEffect(() => {
    ...
    // Scroll to top when lightbox opens
  ...
  return (
    <AnimatePresence>
      <motion.div
        className="fixed inset-0 z-[120] bg-black/90 px-4 py-8 backdrop-blur-xl overflow-y-auto"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      ...
      >
        ...
        <div className="flex items-center justify-between w-full mb-6">
          ...
          {/* Photo Counter */}
          <div className="rounded-full border border-white/10 bg-white/[0.06] px-4 py-1.5 text-[11px] font-medium tracking-widest text-white/50 backdrop-blur-md">
        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-120px)]">
          {/* Previous Button (mobile visible) */}
          <button
            type="button"
            className="flex rounded-full border border-white/15 bg-white/10 p-3 text-white transition hover:bg-white/15 mr-4"
          ...
          {/* Next Button (mobile visible) */}
          <button
            type="button"
            className="flex rounded-full border border-white/15 bg-white/10 p-3 text-white transition hover:bg-white/15 ml-4"
